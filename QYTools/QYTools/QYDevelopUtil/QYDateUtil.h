...
#define QYDateFormatNormal        @"yyyy-MM-dd HH:mm:ss"
#define QYDateFormatNoSeporate    @"yyyyMMddHHmmss"
#define QYDateFormatNoTime        @"yyyy-MM-dd"
#define QYDateFormatNoDate        @"HH:mm:ss"

@interface QYDateUtil : NSObject
